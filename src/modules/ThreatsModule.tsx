...
const ThreatsModule = () => {
  ...
  useEffect(() => {
    ...
    const mockThreats: Threat[] = [
      {
        ...
        description:
          "Large-scale ransomware campaign targeting healthcare and financial sectors through compromised VPN credentials.",
        indicators: [
          "185.220.101.45",
          "malicious-payload.exe",
          "C2: darknet-server.onion",
        ],
      },
      {
        id: "THR-002",
        ...
        description:
          "Previously unknown vulnerability in enterprise software being actively exploited in the wild.",
      ...
      },
      {
        ...
        description:
          "Systematic data theft operation targeting customer databases across multiple organizations.",
      ...
      },
      {
        ...
        description:
          "Coordinated phishing campaign using cloned banking websites to harvest credentials.",
      ...
      },
      {
        ...
        description:
          "Command and control infrastructure for IoT botnet used in DDoS attacks.",
      ...
      },
      {
        ...
        description:
          "Advanced persistent threat targeting software supply chain to distribute backdoored updates.",
      ...
      },
      {
        ...
        lastUpdate: "1 day ago",
        description:
          "Cryptojacking campaign leveraging browser-based mining scripts.",
      ...
      },
      {
        ...
        description:
          "Automated credential stuffing using previously breached password databases.",
      ...
      },
      {
        ...
        lastUpdate: "1 day ago",
        description:
          "Automated SQL injection attempts targeting vulnerable web applications.",
      ...
      },
      {
        ...
        description:
          "Targeted social engineering campaign aimed at executive-level personnel.",
    ...
    const fetchThreats = async () => {
      try {
        ...
        if (data.success) {
          ...
          const apiThreats: Threat[] =
            data.data?.latestFindings?.map((finding: any) => ({
              id: finding.id,
              name: finding.title,
              type: (finding.category && finding.category[0]) || "Threat",
          ...
          setThreats(apiThreats.length > 0 ? apiThreats : mockThreats);
        } else {
    ...
    // Optimistic seed for UI to avoid empty states
    setThreats(mockThreats);
    fetchThreats();
  }, []);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Threats List */}
      <div className="space-y-4" data-testid="threat-list">
