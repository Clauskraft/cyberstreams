-- Database Schema for Cyberstreams
-- This schema sets up all required tables for the threat intelligence platform
...
BEGIN
  ...
  DROP TRIGGER IF EXISTS update_monitoring_sources_updated_at ON monitoring_sources;
