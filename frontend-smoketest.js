...
const testNavigation = async (page) => {
  ...
  const navItems = [
    ...
    {
      selector: '[data-testid="nav-intelligence"]',
      name: "Intelligence Navigation",
    },
      ...
      if (element) {
        ...
        if (isVisible && isEnabled) {
          ...
          logTest(
            ...
            "WARN",
            duration,
            "Navigation item not interactive"
          );
        }
      } else {
...
const testMainComponents = async (page) => {
  ...
  const components = [
    ...
    {
      selector: '[data-testid="cyberstreams-logo"]',
      name: "Logo",
      critical: true,
    },
...
const testThreatsModule = async (page) => {
  ...
  try {
    ...
    const threatsElements = [
      ...
      {
        selector: '[data-testid="severity-indicator"]',
...
const testActivityModule = async (page) => {
  ...
  try {
    ...
    const activityElements = [
      {
        selector: '[data-testid="activity-timeline"]',
        name: "Activity Timeline",
      },
      {
        selector: '[data-testid="activity-filters"]',
